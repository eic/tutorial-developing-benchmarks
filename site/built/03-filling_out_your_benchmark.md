...
![File listing of the completed your_benchmark directory](fig/your_bench_dir_new.png) 
...
![Example output of git status listing the new benchmark files](fig/gitstatus_example.png) 
